      ...
      <View style={{ flex: 1 }}>
        <DrawerContentScrollView {...props}>
          <View style={{
            ...
            <View>
              <Text style={{ color: '#fff', fontFamily: 'Roboto', fontWeight: '600', fontSize: 16, }}>Inspira</Text>
              <Text style={{ color: '#fff', fontFamily: 'Roboto', fontWeight: '600', fontSize: 16, }}>Inspira@gmail.com</Text>
            </View>
